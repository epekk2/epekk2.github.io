...
var createScene = function () {
    ...
    val: new BABYLON.Vector3(4, -4, 0), dims: ['x', 'y', 'z']};
    var move_sphere1 = {obj: sphere1, prop: 'position',
        val: new BABYLON.Vector3(-4, 4, 0), dims: ['x', 'y', 'z']};
    var animations = [];
    animations.push(move_sphere);
    animations.push(move_sphere1);

    var dim_light = {obj: light, prop: 'intensity',
    val: 0, dims: false};
    ...
    var  move_ground = {obj: ground, prop: 'position', val: new BABYLON.Vector3(-10, 0, 0), dims: ['x', 'y', 'z']};
