...
function draw() {
  ...
  textSize(20);
  text('I enjoy getting lost in thought', 65, 30);
  text('I believe in the importance of art', 55, 85);
  text('I welcome new ideas', 100, 140);
  text('I dislike tradition', 120, 195);
  text('I think we should be tough on crime', 40, 250);
  text('I enjoy philisophical discussions', 55, 305);
  text('I easily understand abstract ideas', 48, 360);
  ...
  if (middle == true) {
    ...
    text('You are more likely an open person', 450, 200);
    square(600, 300, 50);
    line(700, 300, 700, 350);
    triangle(690, 300, 710, 300, 700, 290);
    textSize(10);
    text('Your thoughts', 670, 285);
    textSize(20);
    
  } else if (less == true) {
    text ('You are less likely to be an open person', 400, 200);
  }
