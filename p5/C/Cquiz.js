...
function draw() {
  ...
  textSize(20);
  text('I always tell the truth', 100, 30);
  text('I always put things back properly', 55, 85);
  text('I keep my promises', 110, 140);
  text('I keep my room clean', 110, 195);
  text('I have no problem breaking rules', 55, 250);
  text('I reflect on my choices often', 55, 305);
  text('I am always prepared', 100, 360);
  ...
  if (middle == true) {
    ...
    text('You are more likely a conscientious person', 415, 200);

    
  } else if (less == true) {
    text ('You are less likely to be a conscientious', 425, 200);
  }
