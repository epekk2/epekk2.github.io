...
function draw() {
  ...
  textSize(20);
  text('I prefer to be the center of attention', 40, 30);
  text('I easily make friends', 110, 85);
  text('I talk a lot in class', 110, 140);
  text('I enjoy meeting people at parties', 70, 195);
  text('I am easy to get to know', 80, 250);
  text('I find it easy to approach new people', 40, 305);
  text('I know how to keep people entertained', 30, 360);
  ...
  if (middle == true) {
    ...
    text('You are more likely an extroverted person', 415, 200);
    
  } else if (less == true) {
    text ('You are less likely to be an extrovert', 450, 200);
  }
