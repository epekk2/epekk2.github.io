...
function draw() {
  ...
  textSize(20);
  text('I dislike myself', 140, 30);
  text('I panic easily', 145, 85);
  text('I get irritated easily', 120, 140);
  text('I tend to fear the worst', 100, 195);
  text('I feel comfortable with myself', 65, 250);
  text('I have frequent mood swings', 70, 305);
  text('I feel threatened easily', 100, 360);
  ...
  if (middle == true) {
    ...
    text('You are more likely a neurotic person', 415, 200);
    
  } else if (less == true) {
    text ('You are less likely to be a neurotic person', 425, 200);
  }
