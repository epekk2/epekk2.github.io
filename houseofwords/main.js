...
let face = "most recognizable feature"; /*Between the quotation marks,
...
let red = "the best color out there"; //repeat the instructions with the word "red" (keep in the form of a noun)

let brain = "source of life"; //repeat the instructions for the word "brain"

let masculine = "fighting is seen as masculine"; //define 'masculine' in ADJECCTIVE form, so
//you could sub it into a sentence that uses the word as an ADJECTIVE

let think = "I think often"; //define 'think' in VERB form,
